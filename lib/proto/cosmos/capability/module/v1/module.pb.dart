...
class Module extends $pb.GeneratedMessage {
  factory Module({
    $core.bool? sealKeeper,
  }) {
    final $result = create();
    if (sealKeeper != null) {
      $result.sealKeeper = sealKeeper;
    }
    return $result;
  }
  Module._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Module', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.capability.module.v1'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'sealKeeper')
  ...
  @$pb.TagNumber(1)
  $core.bool get sealKeeper => $_getBF(0);
  @$pb.TagNumber(1)
  set sealKeeper($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasSealKeeper() => $_has(0);
  @$pb.TagNumber(1)
  void clearSealKeeper() => clearField(1);
}
