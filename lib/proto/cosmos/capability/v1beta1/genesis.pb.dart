...
class GenesisOwners extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenesisOwners', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.capability.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$63.CapabilityOwners>(2, _omitFieldNames ? '' : 'indexOwners', subBuilder: $63.CapabilityOwners.create)
  ...
  @$pb.TagNumber(2)
  $63.CapabilityOwners get indexOwners => $_getN(1);
  @$pb.TagNumber(2)
  set indexOwners($63.CapabilityOwners v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasIndexOwners() => $_has(1);
  @$pb.TagNumber(2)
  void clearIndexOwners() => clearField(2);
  @$pb.TagNumber(2)
  $63.CapabilityOwners ensureIndexOwners() => $_ensure(1);
}
