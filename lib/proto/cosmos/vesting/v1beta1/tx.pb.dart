...
class MsgCreatePeriodicVestingAccount extends $pb.GeneratedMessage {
  factory MsgCreatePeriodicVestingAccount({
    ...
    $core.Iterable<$72.Period>? vestingPeriods,
  }) {
    final $result = create();
    if (fromAddress != null) {
      $result.fromAddress = fromAddress;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MsgCreatePeriodicVestingAccount', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.vesting.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$72.Period>(4, _omitFieldNames ? '' : 'vestingPeriods', $pb.PbFieldType.PM, subBuilder: $72.Period.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.List<$72.Period> get vestingPeriods => $_getList(3);
}
