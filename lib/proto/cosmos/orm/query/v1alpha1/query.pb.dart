...
class GetResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.orm.query.v1alpha1'), createEmptyInstance: create)
    ..aOM<$43.Any>(1, _omitFieldNames ? '' : 'result', subBuilder: $43.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $43.Any get result => $_getN(0);
  @$pb.TagNumber(1)
  set result($43.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasResult() => $_has(0);
  @$pb.TagNumber(1)
  void clearResult() => clearField(1);
  @$pb.TagNumber(1)
  $43.Any ensureResult() => $_ensure(0);
}
...
class ListRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.orm.query.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$46.PageRequest>(5, _omitFieldNames ? '' : 'pagination', subBuilder: $46.PageRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $46.PageRequest get pagination => $_getN(4);
  @$pb.TagNumber(5)
  set pagination($46.PageRequest v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasPagination() => $_has(4);
  @$pb.TagNumber(5)
  void clearPagination() => clearField(5);
  @$pb.TagNumber(5)
  $46.PageRequest ensurePagination() => $_ensure(4);
}

/// ListResponse is the Query/List response type.
class ListResponse extends $pb.GeneratedMessage {
  factory ListResponse({
    $core.Iterable<$43.Any>? results,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.orm.query.v1alpha1'), createEmptyInstance: create)
    ..pc<$43.Any>(1, _omitFieldNames ? '' : 'results', $pb.PbFieldType.PM, subBuilder: $43.Any.create)
    ..aOM<$46.PageResponse>(5, _omitFieldNames ? '' : 'pagination', subBuilder: $46.PageResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$43.Any> get results => $_getList(0);

  /// pagination is the pagination response.
  @$pb.TagNumber(5)
  $46.PageResponse get pagination => $_getN(1);
  @$pb.TagNumber(5)
  set pagination($46.PageResponse v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class IndexValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IndexValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.orm.query.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$47.Timestamp>(7, _omitFieldNames ? '' : 'timestamp', subBuilder: $47.Timestamp.create)
    ..aOM<$56.Duration>(8, _omitFieldNames ? '' : 'duration', subBuilder: $56.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $47.Timestamp get timestamp => $_getN(6);
  @$pb.TagNumber(7)
  set timestamp($47.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasTimestamp() => $_has(6);
  @$pb.TagNumber(7)
  void clearTimestamp() => clearField(7);
  @$pb.TagNumber(7)
  $47.Timestamp ensureTimestamp() => $_ensure(6);

  /// duration specifies a value for a duration index field.
  @$pb.TagNumber(8)
  $56.Duration get duration => $_getN(7);
  @$pb.TagNumber(8)
  set duration($56.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasDuration() => $_has(7);
  @$pb.TagNumber(8)
  void clearDuration() => clearField(8);
  @$pb.TagNumber(8)
  $56.Duration ensureDuration() => $_ensure(7);
}
