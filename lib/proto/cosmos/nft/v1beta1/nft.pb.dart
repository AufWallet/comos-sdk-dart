...
class Class extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Class', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.nft.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$43.Any>(7, _omitFieldNames ? '' : 'data', subBuilder: $43.Any.create)
  ...
  @$pb.TagNumber(6)
  set uriHash($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  $43.Any get data => $_getN(6);
  @$pb.TagNumber(7)
  set data($43.Any v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasData() => $_has(6);
  @$pb.TagNumber(7)
  void clearData() => clearField(7);
  @$pb.TagNumber(7)
  $43.Any ensureData() => $_ensure(6);
}
...
class NFT extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NFT', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.nft.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'classId')
    ..aOS(2, _omitFieldNames ? '' : 'id')
    ..aOS(3, _omitFieldNames ? '' : 'uri')
    ..aOS(4, _omitFieldNames ? '' : 'uriHash')
    ..aOM<$43.Any>(10, _omitFieldNames ? '' : 'data', subBuilder: $43.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NFT copyWith(void Function(NFT) updates) => super.copyWith((message) => updates(message as NFT)) as NFT;
  ...
  @$pb.TagNumber(4)
  set uriHash($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(10)
  $43.Any get data => $_getN(4);
  @$pb.TagNumber(10)
  set data($43.Any v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasData() => $_has(4);
  @$pb.TagNumber(10)
  void clearData() => clearField(10);
  @$pb.TagNumber(10)
  $43.Any ensureData() => $_ensure(4);
}
