...
class Grant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Grant', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.authz.v1beta1'), createEmptyInstance: create)
    ..aOM<$43.Any>(1, _omitFieldNames ? '' : 'authorization', subBuilder: $43.Any.create)
  ...
  @$pb.TagNumber(1)
  $43.Any get authorization => $_getN(0);
  @$pb.TagNumber(1)
  set authorization($43.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAuthorization() => $_has(0);
  @$pb.TagNumber(1)
  void clearAuthorization() => clearField(1);
  @$pb.TagNumber(1)
  $43.Any ensureAuthorization() => $_ensure(0);
...
class GrantAuthorization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrantAuthorization', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.authz.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$43.Any>(3, _omitFieldNames ? '' : 'authorization', subBuilder: $43.Any.create)
    ..aOM<$47.Timestamp>(4, _omitFieldNames ? '' : 'expiration', subBuilder: $47.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $43.Any get authorization => $_getN(2);
  @$pb.TagNumber(3)
  set authorization($43.Any v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAuthorization() => $_has(2);
  @$pb.TagNumber(3)
  void clearAuthorization() => clearField(3);
  @$pb.TagNumber(3)
  $43.Any ensureAuthorization() => $_ensure(2);

  @$pb.TagNumber(4)
  $47.Timestamp get expiration => $_getN(3);
  @$pb.TagNumber(4)
  set expiration($47.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasExpiration() => $_has(3);
  @$pb.TagNumber(4)
  void clearExpiration() => clearField(4);
  @$pb.TagNumber(4)
  $47.Timestamp ensureExpiration() => $_ensure(3);
}
