...
class Grant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Grant', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.authz.v1beta1'), createEmptyInstance: create)
    ..aOM<$36.Any>(1, _omitFieldNames ? '' : 'authorization', subBuilder: $36.Any.create)
  ...
  @$pb.TagNumber(1)
  $36.Any get authorization => $_getN(0);
  @$pb.TagNumber(1)
  set authorization($36.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAuthorization() => $_has(0);
  @$pb.TagNumber(1)
  void clearAuthorization() => clearField(1);
  @$pb.TagNumber(1)
  $36.Any ensureAuthorization() => $_ensure(0);
...
class GrantAuthorization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrantAuthorization', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.authz.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$36.Any>(3, _omitFieldNames ? '' : 'authorization', subBuilder: $36.Any.create)
    ..aOM<$40.Timestamp>(4, _omitFieldNames ? '' : 'expiration', subBuilder: $40.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $36.Any get authorization => $_getN(2);
  @$pb.TagNumber(3)
  set authorization($36.Any v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAuthorization() => $_has(2);
  @$pb.TagNumber(3)
  void clearAuthorization() => clearField(3);
  @$pb.TagNumber(3)
  $36.Any ensureAuthorization() => $_ensure(2);

  @$pb.TagNumber(4)
  $40.Timestamp get expiration => $_getN(3);
  @$pb.TagNumber(4)
  set expiration($40.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasExpiration() => $_has(3);
  @$pb.TagNumber(4)
  void clearExpiration() => clearField(4);
  @$pb.TagNumber(4)
  $40.Timestamp ensureExpiration() => $_ensure(3);
}
...
class GrantQueueItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrantQueueItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.authz.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GrantQueueItem copyWith(void Function(GrantQueueItem) updates) => super.copyWith((message) => updates(message as GrantQueueItem)) as GrantQueueItem;
