...
class MsgCreateValidator extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MsgCreateValidator', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.staking.v1beta1'), createEmptyInstance: create)
    ..aOM<$66.Description>(1, _omitFieldNames ? '' : 'description', subBuilder: $66.Description.create)
    ..aOM<$66.CommissionRates>(2, _omitFieldNames ? '' : 'commission', subBuilder: $66.CommissionRates.create)
    ..aOS(3, _omitFieldNames ? '' : 'minSelfDelegation')
    ..aOS(4, _omitFieldNames ? '' : 'delegatorAddress')
    ..aOS(5, _omitFieldNames ? '' : 'validatorAddress')
    ..aOM<$36.Any>(6, _omitFieldNames ? '' : 'pubkey', subBuilder: $36.Any.create)
    ..aOM<$42.Coin>(7, _omitFieldNames ? '' : 'value', subBuilder: $42.Coin.create)
  ...
  @$pb.TagNumber(1)
  $66.Description get description => $_getN(0);
  @$pb.TagNumber(1)
  set description($66.Description v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDescription() => $_has(0);
  @$pb.TagNumber(1)
  void clearDescription() => clearField(1);
  @$pb.TagNumber(1)
  $66.Description ensureDescription() => $_ensure(0);

  @$pb.TagNumber(2)
  $66.CommissionRates get commission => $_getN(1);
  @$pb.TagNumber(2)
  set commission($66.CommissionRates v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCommission() => $_has(1);
  @$pb.TagNumber(2)
  void clearCommission() => clearField(2);
  @$pb.TagNumber(2)
  $66.CommissionRates ensureCommission() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  $36.Any get pubkey => $_getN(5);
  @$pb.TagNumber(6)
  set pubkey($36.Any v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPubkey() => $_has(5);
  @$pb.TagNumber(6)
  void clearPubkey() => clearField(6);
  @$pb.TagNumber(6)
  $36.Any ensurePubkey() => $_ensure(5);

  @$pb.TagNumber(7)
  $42.Coin get value => $_getN(6);
  @$pb.TagNumber(7)
  set value($42.Coin v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasValue() => $_has(6);
  @$pb.TagNumber(7)
  void clearValue() => clearField(7);
  @$pb.TagNumber(7)
  $42.Coin ensureValue() => $_ensure(6);
}
...
class MsgDelegate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MsgDelegate', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.staking.v1beta1'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'validatorAddress')
    ..aOM<$42.Coin>(3, _omitFieldNames ? '' : 'amount', subBuilder: $42.Coin.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $42.Coin get amount => $_getN(2);
  @$pb.TagNumber(3)
  set amount($42.Coin v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAmount() => $_has(2);
  @$pb.TagNumber(3)
  void clearAmount() => clearField(3);
  @$pb.TagNumber(3)
  $42.Coin ensureAmount() => $_ensure(2);
}
...
class MsgBeginRedelegate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MsgBeginRedelegate', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.staking.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$42.Coin>(4, _omitFieldNames ? '' : 'amount', subBuilder: $42.Coin.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $42.Coin get amount => $_getN(3);
  @$pb.TagNumber(4)
  set amount($42.Coin v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAmount() => $_has(3);
  @$pb.TagNumber(4)
  void clearAmount() => clearField(4);
  @$pb.TagNumber(4)
  $42.Coin ensureAmount() => $_ensure(3);
}
...
class MsgBeginRedelegateResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MsgBeginRedelegateResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.staking.v1beta1'), createEmptyInstance: create)
    ..aOM<$40.Timestamp>(1, _omitFieldNames ? '' : 'completionTime', subBuilder: $40.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $40.Timestamp get completionTime => $_getN(0);
  @$pb.TagNumber(1)
  set completionTime($40.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCompletionTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearCompletionTime() => clearField(1);
  @$pb.TagNumber(1)
  $40.Timestamp ensureCompletionTime() => $_ensure(0);
}
