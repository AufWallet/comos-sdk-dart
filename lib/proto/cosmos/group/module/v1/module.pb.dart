...
class Module extends $pb.GeneratedMessage {
  factory Module({
    $56.Duration? maxExecutionPeriod,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Module', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.group.module.v1'), createEmptyInstance: create)
    ..aOM<$56.Duration>(1, _omitFieldNames ? '' : 'maxExecutionPeriod', subBuilder: $56.Duration.create)
  ...
  @$pb.TagNumber(1)
  $56.Duration get maxExecutionPeriod => $_getN(0);
  @$pb.TagNumber(1)
  set maxExecutionPeriod($56.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMaxExecutionPeriod() => $_has(0);
  @$pb.TagNumber(1)
  void clearMaxExecutionPeriod() => clearField(1);
  @$pb.TagNumber(1)
  $56.Duration ensureMaxExecutionPeriod() => $_ensure(0);
