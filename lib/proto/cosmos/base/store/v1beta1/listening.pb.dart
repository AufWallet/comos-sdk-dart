...
class BlockMetadata_DeliverTx extends $pb.GeneratedMessage {
  ...
  factory BlockMetadata_DeliverTx.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BlockMetadata_DeliverTx clone() => BlockMetadata_DeliverTx()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BlockMetadata_DeliverTx copyWith(void Function(BlockMetadata_DeliverTx) updates) => super.copyWith((message) => updates(message as BlockMetadata_DeliverTx)) as BlockMetadata_DeliverTx;
  ...
  static $pb.PbList<BlockMetadata_DeliverTx> createRepeated() => $pb.PbList<BlockMetadata_DeliverTx>();
  @$core.pragma('dart2js:noInline')
  static BlockMetadata_DeliverTx getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BlockMetadata_DeliverTx>(create);
