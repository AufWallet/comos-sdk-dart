...
class SnapshotItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SnapshotItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.base.snapshots.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<SnapshotKVItem>(5, _omitFieldNames ? '' : 'kv', subBuilder: SnapshotKVItem.create)
    ..aOM<SnapshotSchema>(6, _omitFieldNames ? '' : 'schema', subBuilder: SnapshotSchema.create)
    ..hasRequiredFields = false
  ;
...
class SnapshotKVItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SnapshotKVItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.base.snapshots.v1beta1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'key', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'value', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SnapshotKVItem copyWith(void Function(SnapshotKVItem) updates) => super.copyWith((message) => updates(message as SnapshotKVItem)) as SnapshotKVItem;
...
class SnapshotSchema extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SnapshotSchema', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.base.snapshots.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SnapshotSchema copyWith(void Function(SnapshotSchema) updates) => super.copyWith((message) => updates(message as SnapshotSchema)) as SnapshotSchema;
