...
import '../../../google/protobuf/descriptor.pb.dart' as $73;
...
class FileDescriptorsResponse extends $pb.GeneratedMessage {
  factory FileDescriptorsResponse({
    $core.Iterable<$73.FileDescriptorProto>? files,
  }) {
    final $result = create();
    if (files != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FileDescriptorsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.reflection.v1'), createEmptyInstance: create)
    ..pc<$73.FileDescriptorProto>(1, _omitFieldNames ? '' : 'files', $pb.PbFieldType.PM, subBuilder: $73.FileDescriptorProto.create)
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$73.FileDescriptorProto> get files => $_getList(0);
}
