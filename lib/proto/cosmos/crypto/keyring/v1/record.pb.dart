...
class Record_Local extends $pb.GeneratedMessage {
  ...
  factory Record_Local.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Record.Local', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.crypto.keyring.v1'), createEmptyInstance: create)
    ..aOM<$36.Any>(1, _omitFieldNames ? '' : 'privKey', subBuilder: $36.Any.create)
  ...
  'Will be removed in next major version')
  Record_Local copyWith(void Function(Record_Local) updates) => super.copyWith((message) => updates(message as Record_Local)) as Record_Local;
  ...
  static $pb.PbList<Record_Local> createRepeated() => $pb.PbList<Record_Local>();
  @$core.pragma('dart2js:noInline')
  static Record_Local getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Record_Local>(create);
  static Record_Local? _defaultInstance;

  @$pb.TagNumber(1)
  $36.Any get privKey => $_getN(0);
  @$pb.TagNumber(1)
  set privKey($36.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPrivKey() => $_has(0);
  @$pb.TagNumber(1)
  void clearPrivKey() => clearField(1);
  @$pb.TagNumber(1)
  $36.Any ensurePrivKey() => $_ensure(0);
}
...
class Record_Ledger extends $pb.GeneratedMessage {
  ...
  factory Record_Ledger.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Record.Ledger', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.crypto.keyring.v1'), createEmptyInstance: create)
    ..aOM<$56.BIP44Params>(1, _omitFieldNames ? '' : 'path', subBuilder: $56.BIP44Params.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Record_Ledger copyWith(void Function(Record_Ledger) updates) => super.copyWith((message) => updates(message as Record_Ledger)) as Record_Ledger;
  ...
  static $pb.PbList<Record_Ledger> createRepeated() => $pb.PbList<Record_Ledger>();
  @$core.pragma('dart2js:noInline')
  static Record_Ledger getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Record_Ledger>(create);
  static Record_Ledger? _defaultInstance;

  @$pb.TagNumber(1)
  $56.BIP44Params get path => $_getN(0);
  @$pb.TagNumber(1)
  set path($56.BIP44Params v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPath() => $_has(0);
  @$pb.TagNumber(1)
  void clearPath() => clearField(1);
  @$pb.TagNumber(1)
  $56.BIP44Params ensurePath() => $_ensure(0);
}
...
class Record_Multi extends $pb.GeneratedMessage {
  ...
  factory Record_Multi.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Record_Multi.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Record.Multi', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.crypto.keyring.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Record_Multi copyWith(void Function(Record_Multi) updates) => super.copyWith((message) => updates(message as Record_Multi)) as Record_Multi;
  ...
  static $pb.PbList<Record_Multi> createRepeated() => $pb.PbList<Record_Multi>();
  @$core.pragma('dart2js:noInline')
  static Record_Multi getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Record_Multi>(create);
...
class Record_Offline extends $pb.GeneratedMessage {
  ...
  factory Record_Offline.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Record_Offline.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Record.Offline', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.crypto.keyring.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Record_Offline copyWith(void Function(Record_Offline) updates) => super.copyWith((message) => updates(message as Record_Offline)) as Record_Offline;
  ...
  static $pb.PbList<Record_Offline> createRepeated() => $pb.PbList<Record_Offline>();
  @$core.pragma('dart2js:noInline')
  static Record_Offline getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Record_Offline>(create);
...
class Record extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Record', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.crypto.keyring.v1'), createEmptyInstance: create)
    ...
    ..aOM<Record_Offline>(6, _omitFieldNames ? '' : 'offline', subBuilder: Record_Offline.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set local(Record_Local v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set ledger(Record_Ledger v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set multi(Record_Multi v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set offline(Record_Offline v) { setField(6, v); }
  @$pb.TagNumber(6)
