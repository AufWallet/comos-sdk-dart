...
class MsgUpdateParams extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MsgUpdateParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.slashing.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$74.Params>(2, _omitFieldNames ? '' : 'params', subBuilder: $74.Params.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $74.Params get params => $_getN(1);
  @$pb.TagNumber(2)
  set params($74.Params v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasParams() => $_has(1);
  @$pb.TagNumber(2)
  void clearParams() => clearField(2);
  @$pb.TagNumber(2)
  $74.Params ensureParams() => $_ensure(1);
}
