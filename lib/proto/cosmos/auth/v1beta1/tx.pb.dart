...
class MsgUpdateParams extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MsgUpdateParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.auth.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$45.Params>(2, _omitFieldNames ? '' : 'params', subBuilder: $45.Params.create)
  ...
  @$pb.TagNumber(2)
  $45.Params get params => $_getN(1);
  @$pb.TagNumber(2)
  set params($45.Params v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasParams() => $_has(1);
  @$pb.TagNumber(2)
  void clearParams() => clearField(2);
  @$pb.TagNumber(2)
  $45.Params ensureParams() => $_ensure(1);
}
