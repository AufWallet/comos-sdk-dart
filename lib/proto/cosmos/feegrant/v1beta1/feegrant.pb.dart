...
class BasicAllowance extends $pb.GeneratedMessage {
  factory BasicAllowance({
    $core.Iterable<$50.Coin>? spendLimit,
    $47.Timestamp? expiration,
  }) {
    final $result = create();
    if (spendLimit != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BasicAllowance', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.feegrant.v1beta1'), createEmptyInstance: create)
    ..pc<$50.Coin>(1, _omitFieldNames ? '' : 'spendLimit', $pb.PbFieldType.PM, subBuilder: $50.Coin.create)
    ..aOM<$47.Timestamp>(2, _omitFieldNames ? '' : 'expiration', subBuilder: $47.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$50.Coin> get spendLimit => $_getList(0);

  /// expiration specifies an optional time when this allowance expires
  @$pb.TagNumber(2)
  $47.Timestamp get expiration => $_getN(1);
  @$pb.TagNumber(2)
  set expiration($47.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExpiration() => $_has(1);
  @$pb.TagNumber(2)
  void clearExpiration() => clearField(2);
  @$pb.TagNumber(2)
  $47.Timestamp ensureExpiration() => $_ensure(1);
}
...
class PeriodicAllowance extends $pb.GeneratedMessage {
  factory PeriodicAllowance({
    ...
    $56.Duration? period,
    $core.Iterable<$50.Coin>? periodSpendLimit,
    $core.Iterable<$50.Coin>? periodCanSpend,
    $47.Timestamp? periodReset,
  }) {
    final $result = create();
    if (basic != null) {
      $result.basic = basic;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PeriodicAllowance', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.feegrant.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$56.Duration>(2, _omitFieldNames ? '' : 'period', subBuilder: $56.Duration.create)
    ..pc<$50.Coin>(3, _omitFieldNames ? '' : 'periodSpendLimit', $pb.PbFieldType.PM, subBuilder: $50.Coin.create)
    ..pc<$50.Coin>(4, _omitFieldNames ? '' : 'periodCanSpend', $pb.PbFieldType.PM, subBuilder: $50.Coin.create)
    ..aOM<$47.Timestamp>(5, _omitFieldNames ? '' : 'periodReset', subBuilder: $47.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $56.Duration get period => $_getN(1);
  @$pb.TagNumber(2)
  set period($56.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPeriod() => $_has(1);
  @$pb.TagNumber(2)
  void clearPeriod() => clearField(2);
  @$pb.TagNumber(2)
  $56.Duration ensurePeriod() => $_ensure(1);

  /// period_spend_limit specifies the maximum number of coins that can be spent
  /// in the period
  @$pb.TagNumber(3)
  $core.List<$50.Coin> get periodSpendLimit => $_getList(2);

  /// period_can_spend is the number of coins left to be spent before the period_reset time
  @$pb.TagNumber(4)
  $core.List<$50.Coin> get periodCanSpend => $_getList(3);

  /// period_reset is the time at which this period resets and a new one begins,
  /// it is calculated from the start time of the first transaction after the
  /// last period ended
  @$pb.TagNumber(5)
  $47.Timestamp get periodReset => $_getN(4);
  @$pb.TagNumber(5)
  set periodReset($47.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasPeriodReset() => $_has(4);
  @$pb.TagNumber(5)
  void clearPeriodReset() => clearField(5);
  @$pb.TagNumber(5)
  $47.Timestamp ensurePeriodReset() => $_ensure(4);
}
...
class AllowedMsgAllowance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllowedMsgAllowance', package: const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.feegrant.v1beta1'), createEmptyInstance: create)
    ..aOM<$43.Any>(1, _omitFieldNames ? '' : 'allowance', subBuilder: $43.Any.create)
  ...
  @$pb.TagNumber(1)
  $43.Any get allowance => $_getN(0);
  @$pb.TagNumber(1)
  set allowance($43.Any v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAllowance() => $_has(0);
  @$pb.TagNumber(1)
  void clearAllowance() => clearField(1);
  @$pb.TagNumber(1)
  $43.Any ensureAllowance() => $_ensure(0);
